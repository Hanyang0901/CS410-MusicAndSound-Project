...
class SpectrumAnalyzer:
    def __init__(self):
        ...
        self.spectrum.setYRange(-100, 10, padding=0)
    ...
    def update(self):
        ...
        spectrum_data_dB = 20 * np.log10(spectrum_data / max(spectrum_data))
        # update curve
        self.spectrum_plot.setData(self.f, spectrum_data_dB)
